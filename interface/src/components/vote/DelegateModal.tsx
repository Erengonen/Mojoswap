...
export default function DelegateModal({ isOpen, onDismiss, title }: VoteModalProps) {
  ...
  const uniBalance = useTokenBalance(account ?? undefined, chainId ? MOJO[chainId] : undefined)
      ...
      {!attempting && !hash && (
        <ContentWrapper gap="lg">
          <AutoColumn gap="lg" justify="center">
            ...
            <TYPE.body>Earned MOJO tokens represent voting shares in Mojoswap governance.</TYPE.body>
            <TYPE.body>
