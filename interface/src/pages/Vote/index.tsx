...
import { MOJO, ZERO_ADDRESS } from '../../constants'
...
export default function Vote() {
  ...
  const uniBalance: TokenAmount | undefined = useTokenBalance(account ?? undefined, chainId ? MOJO[chainId] : undefined)
  ...
  return (
    <PageWrapper gap="lg" justify="center">
      ...
      <TopSection gap="md">
        <VoteCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>Mojoswap Governance</TYPE.white>
              </RowBetween>
              <RowBetween>
                <TYPE.white fontSize={14}>
                  MOJO tokens represent voting shares in Mojoswap governance. You can vote on each proposal yourself or
                  delegate your votes to a third party.
                </TYPE.white>
              </RowBetween>
              <ExternalLink
                style={{ color: 'white', textDecoration: 'underline' }}
                href="https://mojoswap.org/blog/MOJO"
                target="_blank"
              >
                <TYPE.white fontSize={14}>Read more about Mojoswap governance</TYPE.white>
              </ExternalLink>
            </AutoColumn>
          </CardSection>
          <CardBGImage />
      ...
      <TYPE.subHeader color="text3">
        A minimum threshhold of 1% of the total MOJO supply is required to submit proposals
      </TYPE.subHeader>
    </PageWrapper>
  )
}
